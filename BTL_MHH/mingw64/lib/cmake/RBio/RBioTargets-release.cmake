...
set_target_properties(SuiteSparse::RBio PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/librbio.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "SuiteSparse::SuiteSparseConfig"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/librbio.dll"
  )

list(APPEND _cmake_import_check_targets SuiteSparse::RBio )
list(APPEND _cmake_import_check_files_for_SuiteSparse::RBio "${_IMPORT_PREFIX}/lib/librbio.dll.a" "${_IMPORT_PREFIX}/bin/librbio.dll" )
